...
export function ingestFromMarkdownDocs() {
  ...
  const docPaths = [
    { repo: 'X4_Forge', file: path.resolve('KNOWN-BUGS.md'), category: 'x4_forge' },
    { repo: 'X4_Forge', file: path.resolve('ROADMAP.md'), category: 'x4_forge' },
    { repo: 'X4_Forge', file: path.resolve('SESSION-HANDOFF.md'), category: 'x4_forge' },
    { repo: 'x4_ai_influence', file: path.resolve('../x4_ai_influence/README.md'), category: 'x4_ailive' },
    { repo: 'x4_ai_influence', file: path.resolve('../x4_ai_influence/docs/ROADMAP.md'), category: 'x4_ailive' },
    { repo: 'x4_ai_influence', file: path.resolve('../x4_ai_influence/docs/BACKLOG.md'), category: 'x4_ailive' }
  ];
